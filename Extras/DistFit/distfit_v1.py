''' 
    Few updates in this file includes: 
      - Added expected and observed data in addition to parameters after each fit
      - Making sure that for bernoulli fit, always p is less than 1
      - Tried multiple ways to add goodness of fit as part of this package, but still got the same error
'''
...
class Fitting():
    ...
    def bernoulli_fit(self):
        ...
        expected_data = np.random.binomial(1,p, size=self.size)
        return observed_data, expected_data, p
        #return p
    ...
    def binomial_fit(self, n):
        ...
        p = self.mu/n
        observed_data = self.data
        expected_data = np.random.binomial(n, p, size=self.size)
        return observed_data, expected_data, (n, p)
        #return (n, p)
    ...
    def geometric_fit(self):
        ...
        p = 1/(self.mu+1)
        observed_data = self.data
        expected_data = np.random.geometric(p, size=self.size)
        return observed_data, expected_data, p
        #return p
    ...
    def poisson_fit(self):
        ...
        _lambda = self.mu
        observed_data = self.data
        expected_data = np.random.poisson(_lambda, size=self.size)
        return observed_data, expected_data, _lambda
        #return _lambda
    ...
    def uniform_fit(self):
        ...
        b = self.data_max
        observed_data = self.data
        expected_data = np.random.uniform(a,b, size=self.size)
        return observed_data, expected_data, (a,b)
        #return (a,b)
    ...
    def exponential_fit(self):
        ...
        '''
        observed_data = self.data
        expected_data = np.random.exponential(self.mu, size=self.size)
        return observed_data, expected_data, self.mu
        #return self.mu
    ...
    def normal_fit(self):
        ...
        observed_data = self.data
        expected_data = np.random.normal(mu, sigma, size=self.size)
        return observed_data, expected_data, (mu, sigma)
    ...
    def weibull_fit(self, tol=0.001):
        ...
        observed_data = self.data
        expected_data = np.random.weibull(beta, size=self.size)*alfa_new
        return observed_data, expected_data, (alfa_new, beta)
    ...
    def gamma_fit(self):
        ...
        beta = self.mu/alfa
        observed_data = self.data
        expected_data = np.random.gamma(beta, alfa, size=self.size)
        return observed_data, expected_data, (alfa, beta)
        return (alfa, beta)
